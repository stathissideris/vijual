...
(comment
 (draw-directed-graph
  [["AFn" "Obj"]
   ...
   ["IteratorStream" "AFn"]
   ["Keyword" "IFn"]
   ["LazilyPersistentVector" "APersistentVector"]
   ["LazySeq" "Obj"]
   ["LazySeq" "ISeq"]
   ["LazySeq" "List"]
   ["List" "Collection"]
   ...
   ["Obj" "IObj"]
   ["Object$Future$IDeref" "IProxy"]
   ["Object$Future$IDeref" "IDeref"]
   ["Object$Future$IDeref" "Future"]
   ...
   ["Symbol" "AFn"]
   ["Symbol" "Serializable"]
   ["TransactionalHashMap" "ConcurrentMap"]
   ["Var" "ARef"]
   ["Var" "IFn"]
   ["Var" "IRef"]
   ["Var" "Settable"]]))
...
;; (-> (draw-directed-graph-image [[:a :b] [:a :f] [:a :c] [:b :c] [:c :d] [:d :e] [:e :f] [:f :a]])
;;    (save-image "example"))
